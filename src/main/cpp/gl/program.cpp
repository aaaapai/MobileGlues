...
ankerl::unordered_dense::map<GLuint, bool> program_map_is_sampler_buffer_emulated;

extern ankerl::unordered_dense::map<GLuint, bool> shader_map_is_atomic_counter_emulated;
ankerl::unordered_dense::map<GLuint, bool> program_map_is_atomic_counter_emulated;
