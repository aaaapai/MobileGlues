...
static unordered_map<GLuint, GLuint> g_gen_buffers;
static unordered_map<GLuint, GLuint> g_gen_arrays;

static unordered_map<GLenum, GLuint> g_bound_buffers;
static GLuint bound_array = 0;

static unordered_map<GLuint, BufferMapping> g_active_mappings;
