...
GLAPI GLAPIENTRY void mg_glMultiDrawElementsBaseVertex_ltw(GLenum mode, GLsizei *counts, GLenum type, const void *const *indices, GLsizei primcount, const GLint *basevertex);
