...
GLenum GetBindingQuery(GLenum target, bool forceTexture = false) {
	...
	case GL_PARAMETER_BUFFER_ARB:          return GL_PARAMETER_BUFFER_BINDING_ARB;
	...
	case GL_TRANSFORM_FEEDBACK_BUFFER_EXT: return GL_TRANSFORM_FEEDBACK_BUFFER_BINDING_EXT;
	case GL_VERTEX_SHADER_EXT:             return GL_VERTEX_SHADER_BINDING_EXT;
	case GL_VERTEX_SHADER:                 return GL_VERTEX_SHADER_BINDING;
